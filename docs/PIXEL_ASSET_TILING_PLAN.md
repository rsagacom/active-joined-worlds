...
| 世界广场 | `apps/lobster-web-shell/assets/pixel/concepts/world-square-concept-20260427-256.png` | 广场地砖、道路 | 夜景作为基准，白天需要同构重绘，不用夜景调色；原始概念 PNG 归档在 `/Volumes/AJW-Data/Projects/lobster-chat-assets-archive/20260516-web-source-assets/concepts/` |
