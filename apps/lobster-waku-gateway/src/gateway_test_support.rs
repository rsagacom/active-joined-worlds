...
pub(super) fn http_json(
    ...
    let (status, payload) = http_json_with_headers(method, base_url, path, &[], body);
    (status, payload)
}

pub(super) fn http_json_with_headers(
    method: &str,
    base_url: &str,
    path: &str,
    ...
    let (status, _headers, body) =
        http_raw_with_headers(method, base_url, path, extra_headers, body);
...
pub(super) fn http_raw(
    ...
    http_raw_with_headers(method, base_url, path, &[], body)
}

pub(super) fn http_raw_with_headers(
    method: &str,
    base_url: &str,
    path: &str,
    extra_headers: &[(&str, &str)],
