...
(function () {
  ...
  data.labels = {
    ...
    msgStatusTag: { pending: 'warning', passed: 'success', flagged: 'danger', blocked: 'default', approved: 'success', handled: 'info' },
    msgStatusText: { pending: '待审核', passed: '已通过', flagged: '已标记', blocked: '已屏蔽', approved: '已通过', handled: '已处理' },
