...
test("hub page is now main-city group chat page with canvas and timeline", async () => {
  ...
  assert.match(html, /styles\.base\.css\?v=20260731-ui-refresh-r2/);
  assert.match(html, /styles\.scene\.css\?v=20260731-ui-refresh-r2/);
  assert.match(html, /styles\.chat\.css\?v=20260731-ui-refresh-r2/);
  assert.match(html, /styles\.css\?v=20260731-ui-refresh-r2/);
  assert.match(html, /styles\.user-shell\.css\?v=20260731-ui-refresh-r2/);
  assert.match(html, /styles\.pixel-map\.css\?v=20260731-ui-refresh-r2/);
  assert.match(html, /app\.js\?v=20260731-ui-refresh-r2/);
...
test("creative page is the residential pixel room entry", async () => {
  ...
  assert.match(html, /styles\.creative\.css\?v=20260731-ui-refresh-r2/);
  assert.match(html, /styles\.user-shell\.css\?v=20260731-ui-refresh-r2/);
  assert.match(html, /styles\.pixel-map\.css\?v=20260731-ui-refresh-r2/);
  assert.match(html, /app\.js\?v=20260731-ui-refresh-r2/);
  assert.match(html, /data-symbol-trigger/);
...
test("admin page has collapsible management navigation and tool groups", async () => {
  ...
  assert.match(html, /href="\.\/styles\.base\.css\?v=20260731-ui-refresh-r2"/);
  assert.match(html, /href="\.\/styles\.scene\.css\?v=20260731-ui-refresh-r2"/);
  assert.match(html, /href="\.\/styles\.chat\.css\?v=20260731-ui-refresh-r2"/);
  assert.match(html, /href="\.\/styles\.css\?v=20260731-ui-refresh-r2"/);
  assert.match(html, /href="\.\/styles\.user-shell\.css\?v=20260731-ui-refresh-r2"/);
...
test("unified page is world-entry metro station with pixel scene and hotspots", async () => {
  ...
  assert.match(html, /data-sfc-theme="city"/);
  assert.match(html, /href="\.\/styles\.world-entry\.css\?v=20260731-ui-refresh-r2/);
  assert.match(html, /app\.js\?v=20260731-ui-refresh-r2/);
  assert.match(html, /href="\.\/creative\.html"/);
  assert.match(html, /href="\.\/index\.html"/);
  assert.match(html, /href="\.\/world-square\.html"/);
...
test("world-square page is a readonly public square entry", async () => {
  ...
  assert.match(html, /styles\.world-square\.css\?v=20260731-ui-refresh-r2/);
